...
public class SinglyLinkedList {
    ...
    //     reversedList.createFromArray(arr);
    //     return reversedList;
    // }

    // Simpler implementation without using an array
    public SinglyLinkedList reverseOutOfPlace() {
        SinglyLinkedList reversedList = new SinglyLinkedList();
        Node current = head;
        while (current != null) {
    ...
    public void reverseInPlace() {
        ...
        while (current != null) {
            ...
            // because after reversing the link, current.next points to prev,
            // and we would lose access to the rest of the list.
            next = current.next;
            current.next = prev;
            prev = current;
            current = next;
            // Move to the next node using the saved reference.
        }
        head = prev;
    }
